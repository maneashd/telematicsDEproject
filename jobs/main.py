...
VEHICLE_TOPIC = os.getenv('VEHICLE_TOPIC', 'vehicle_data') # means get the vehicle data from VEHICLE_TOPIC if that is not available get data from vehicle_data
...
if __name__ == "__main__":
    # this config is confluence kafka broker information
    producer_config = {
